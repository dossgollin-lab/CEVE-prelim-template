---
title: My Title  # The title of the document
author: My Name  # The author of the document
date: 2025-03-17  # The date of the document
...
bibliography: ../shared/references.bib  # Path to bibliography file
csl: ../shared/american-geophysical-union.csl  # Path to CSL file for citation styling
---

# Introduction

This is an example Quarto + LaTeX template for a grant proposal.
...
This makes it easier to use tools like git to track changes.open latex
...
\frac{\partial^{2} \mathrm C}{\partial \mathrm S^2}
  ...
  \mathrm r \mathrm C 
$$ {#eq-black-scholes}
We can also use inline equations, like this: $sin(x) \approx x$.
